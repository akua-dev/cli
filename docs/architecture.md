...
skills/agent-skills-standard-following/
                                 canonical versioned Akua agent skill artifact
...
- canonical agent skill frontmatter, provenance, deterministic package digest,
  and release version wiring;
