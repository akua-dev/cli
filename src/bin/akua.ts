...
function helpView(): RenderEnvelope {
  return {
    ...
    observations: [
      ...
      "  akua agent-os load-hcloud-provider --workspace <exact-name-or-ws_id> --token-file <absolute-path> --project-identity-attestation <issuer-attestation> [--project-anchor-ssh-key-fingerprint <SHA256:fingerprint>]",
